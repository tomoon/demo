...
public class PlaylistBrowserActivity extends MusicBaseListActivity
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        //MusicUtils.updateButtonBar(this, R.id.playlisttab);  //lnliu need remove
	...
	lv.setOnTouchListener(new View.OnTouchListener() {
	   ...
	   public boolean onTouch(View v, MotionEvent event) {
	       ...
	       if(PlaylistBrowserActivity.this.onTouchEvent(event)){
		   return true;
	       }
	       return false;
	   }
    ...
    */    
	...
	public void flingLeft() {
	    // TODO Auto-generated method stub
	    Intent i = new Intent(this,PlaylistBrowserSettingActivity.class);
	    startActivity(i);
	}
