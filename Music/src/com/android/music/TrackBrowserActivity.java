...
public class TrackBrowserActivity extends MusicBaseListActivity
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public static final int SAVE_AS_PLAYLIST_RESULT = CHILD_MENU_BASE + 7;
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        //mUseLastListPos = MusicUtils.updateButtonBar(this, R.id.songtab); //lnliu need remove
	...
	mTrackList.setOnTouchListener(new View.OnTouchListener() {
		...
		public boolean onTouch(View v, MotionEvent event) {
		    ...
		    Log.d("ArtistAlbumBrowserActivity","onTouch action="+event.getAction());
		    if(TrackBrowserActivity.this.onTouchEvent(event)){
			return true;
		    }
		    return false;
		}
    ...
    */
    ...
    private class NowPlayingCursor extends AbstractCursor
    {
        ...
        private void makeNowPlayingCursor() {
        	if(mCurrentPlaylistCursor!=null&&!mCurrentPlaylistCursor.isClosed()){//hlwang
        		Log.d(LOGTAG, "Cursor is not close ,so close it");
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        private void getColumnIndices(Cursor cursor) {
            if (cursor != null) {
                ...
                mFilePathIdx=cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DATA);
                try {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            mFilePath=cursor.getString(mFilePathIdx);
            if(mFilePath.startsWith("/storage/sdcard1/"))
           {
        	   vh.line1.append("   *");
           }
            if (secs == 0) {
	...
	// TODO Auto-generated method stub
	Intent i = new Intent(this,TrackBrowserSettingActivity.class);
	//ArtistAlbumSettingActivity.setCallback(this);
	TrackBrowserSettingActivity.setCallBackListener(this);
	i.putIntegerArrayListExtra("setting_show_action", showAction());
	startActivity(i);
    }
	...
	// TODO Auto-generated method stub
	Log.d("ArtistAlbumBrowserActivity","call flingRight");
	MusicUtils.FlingRight(this);
    }
    

    private ArrayList<Integer> showAction(){	
	ArrayList<Integer> intArrayList = new ArrayList();
	if (mPlaylist == null) {
	    intArrayList.add(PLAY_ALL);
        }
	intArrayList.add(PARTY_SHUFFLE);
	intArrayList.add(SHUFFLE_ALL);
	
        if (mPlaylist != null) {
	    intArrayList.add(SAVE_AS_PLAYLIST);
            if (mPlaylist.equals("nowplaying")) {
		intArrayList.add(CLEAR_PLAYLIST);
            }
        }
	return intArrayList;
    }

    public void callback(View view,int action,Object exterData){
	Log.d("TrackBrowserActivity","action ="+action);
	Intent intent;
        Cursor cursor;
		...
		break;
            ...
            case SAVE_AS_PLAYLIST:
                ...
                startActivityForResult(intent, SAVE_AS_PLAYLIST);
                break;
	case SAVE_AS_PLAYLIST_RESULT:
	    if(exterData!=null){
		Uri uri = (Uri) exterData; 
		if (uri != null) {
		    long [] list = MusicUtils.getSongListForCursor(mTrackCursor);
		    int plid = Integer.parseInt(uri.getLastPathSegment());
		    MusicUtils.addToPlaylist(this, list, plid);
