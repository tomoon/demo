...
public class ArtistAlbumBrowserActivity extends ArtistAlbumBaseActivity
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE);*/ //lnliu need remove
        ...
        //MusicUtils.updateButtonBar(this, R.id.artisttab); //lnliu need remove
	...
	lv.setOnTouchListener(new View.OnTouchListener() {
		@Override
		    ...
		    if(ArtistAlbumBrowserActivity.this.onTouchEvent(event)){
			return true;
		    }
		    //}
		    return false;
	...
	Log.d("ArtistAlbumBrowserActivity","onChildClick groupPosition="+groupPosition+",childPosition="+childPosition+",id="+id+",mCurrentAlbumId="+mCurrentAlbumId+",mCurrentArtistId="+mCurrentArtistId);
    ...
    */
    ...
    static class ArtistAlbumListAdapter extends SimpleCursorTreeAdapter implements SectionIndexer {
        ...
        public View newChildView(Context context, Cursor cursor, boolean isLastChild,
            ...
            vh.icon.setPadding(0, 0, 1, 0);
            v.setTag(vh);
	    Log.d("ArtistAlbumBrowserActivity","newChildView() isLastChild="+isLastChild);
            return v;
        }
	    ...
	    Log.d("ArtistAlbumBrowserActivity","bindChildView() displayname="+displayname+",numartistsongs="+numartistsongs);
            if (numsongs == 1) {
	...
	public void flingLeft() {
		// TODO Auto-generated method stub
	    Intent i = new Intent(this,ArtistAlbumSettingActivity.class);
	    startActivity(i);
