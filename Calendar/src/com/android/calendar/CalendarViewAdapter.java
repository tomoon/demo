...
public class CalendarViewAdapter extends BaseAdapter {
    ...
    public static final int CALENDAR_BUTTON_INDEX_FOR_WATCH=0;
    public static final int AGENDA_BUTTON_INDEX_FOR_WATCH=1;
    ...
    public CalendarViewAdapter(Context context, int viewType, boolean showDate) {
		...
		if (!CalendarApplication.isWatch) {
			mButtonNames = context.getResources().getStringArray(
					R.array.buttons_list);
		} else {
			mButtonNames = context.getResources().getStringArray(
					R.array.buttons_list_for_watch);
		}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mShowDate) {
           ...
           if(CalendarApplication.isWatch){
               switch (mCurrentMainView) {
                case ViewType.MONTH:
                    title.setText(mButtonNames [CALENDAR_BUTTON_INDEX_FOR_WATCH]);
                    break;
                case ViewType.AGENDA:
                    title.setText(mButtonNames [AGENDA_BUTTON_INDEX_FOR_WATCH]);
                    break;
                default:
                    v = null;
                    break;
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if(CalendarApplication.isWatch){//for watch
                switch (position) {
             case CALENDAR_BUTTON_INDEX_FOR_WATCH:
                 viewType.setText(mButtonNames [CALENDAR_BUTTON_INDEX_FOR_WATCH]);
                 if (mShowDate) {
                     date.setText(buildMonthDate());
                 }
                 break;
             case AGENDA_BUTTON_INDEX_FOR_WATCH:
                 viewType.setText(mButtonNames [AGENDA_BUTTON_INDEX_FOR_WATCH]);
                 if (mShowDate) {
